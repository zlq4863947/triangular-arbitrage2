...
describe('BigNumber util functions', () => {
  describe('addToString', () => {
    it('should return expected value.', () => {
      ...
      expect(addToString(1, 2, 3)).toEqual('6');
      expect(addToString(1, 2, 3, 4)).toEqual('10');
      expect(addToString('1', '2')).toEqual('3');
  ...
  describe('subtractToString', () => {
    it('should return expected value.', () => {
      ...
      expect(subtractToString(1, 2, 3)).toEqual('-4');
      expect(subtractToString(1, 2, 3, 4)).toEqual('-8');
      expect(subtractToString('1', '2')).toEqual('-1');
  ...
  describe('multipleToString', () => {
    it('should return expected value.', () => {
      ...
      expect(multipleToString(1, 2, 3)).toEqual('6');
      expect(multipleToString(1, 2, 3, 4)).toEqual('24');
      expect(multipleToString('1', '2')).toEqual('2');
  ...
  describe('divideToString', () => {
    it('should return expected value.', () => {
      ...
      expect(divideToString(1, 2, 2)).toEqual('0.25');
      expect(divideToString(1, 2, 2, 2)).toEqual('0.125');
      expect(divideToString('1', '2')).toEqual('0.5');
